...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Slime RNG Wiki",
    description: "Read the Terms of Service for Slime RNG Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Slime RNG Wiki",
      description: "Terms and conditions for using Slime RNG Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Slime RNG Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Slime RNG Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Slime RNG Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Slime RNG Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox game "Slime RNG". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Code, reward, and redeem information</li>
              <li>Slime collection and rarity guides</li>
              <li>Recipe location and world progression guides</li>
              <li>Luck boost, upgrade, and enemy slime tips</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Slime RNG Wiki is NOT affiliated with, endorsed by, or associated with
              Roblox Corporation or the official developers of Slime RNG. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Slime RNG Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Roblox Corporation and/or the developers of Slime RNG. We use such
            ...
            <ul>
              ...
              <li><strong>Game Availability:</strong> Roblox experience availability, codes, rewards, and game updates may change without notice. We are not responsible for platform access or game changes.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, SLIME RNG WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              The Website may contain links to third-party websites, including Roblox, official community pages, social media platforms,
            ...
            <p>
              ...
              you and Slime RNG Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@slime-rng.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@slime-rng.wiki</a>
            </p>
            <p>
